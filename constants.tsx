...
const romajiMap: Record<string, string> = {
  ...
  "さ": "sa", "し": "shi", "す": "su", "せ": "se", "そ": "so", "た": "ta", "ち": "chi", "つ": "tsu", "て": "to", "と": "to",
  "な": "na", "ni": "ni", "ぬ": "nu", "ね": "ne", "の": "no", "は": "ha", "ひ": "hi", "ふ": "fu", "へ": "he", "ほ": "ho",
  ...
  "サ": "sa", "シ": "shi", "ス": "su", "セ": "se", "ソ": "so", "タ": "ta", "チ": "chi", "ツ": "tsu", "テ": "to", "ト": "to",
...
// Fixing missing romaji entries manually if any
romajiMap["な"] = "na"; romajiMap["に"] = "ni";
